...
<img
  ...
  src="/images/new-agent/light/name.png"
  alt="Nome do agente"
/>
<img
  className="hidden dark:block rounded-xl"
  src="/images/new-agent/dark/name.png"
  alt="Nome do agente"
/>
...
<img
  className="block dark:hidden rounded-xl border border-gray-300"
  src="/images/new-agent/light/purpose.png"
  alt="Objetivo"
/>
<img
  className="hidden dark:block rounded-xl"
  src="/images/new-agent/dark/purpose.png"
  alt="Objetivo"
/>
...
<img
  className="block dark:hidden rounded-xl border border-gray-300"
  src="/images/new-agent/light/job-name.png"
  alt="Nome da empresa"
/>
<img
  className="hidden dark:block rounded-xl"
  src="/images/new-agent/dark/job-name.png"
  alt="Nome da empresa"
/>
...
<img
  className="block dark:hidden rounded-xl border border-gray-300"
  src="/images/new-agent/light/job-description.png"
  alt="Descrição da empresa"
/>
<img
  className="hidden dark:block rounded-xl"
  src="/images/new-agent/dark/job-description.png"
  alt="Descrição da empresa"
/>
...
<b>Solicitar ajuda humana:</b> Habilite esta opção para permitir que o agente possa
...
solicita falar com um atendente humano.

<b>Usar Emojis Nas Respostas:</b> Decida se o agente pode utilizar emojis em suas
respostas. Essa configuração pode ajudar a tornar a comunicação mais amigável e engajante,
dependendo do perfil do seu público-alvo.

<b>Restringir Temas Permitidos:</b> Marque esta opção para garantir que o agente
não fale sobre outros assuntos que não estejam dentro do escopo permitido. Isso ajuda
a manter o foco e a relevância das respostas fornecidas pelo agente.

<b>Dividir Resposta em Partes:</b> Ative esta configuração para que o agente possa
dividir respostas longas em várias mensagens. Isso melhora a legibilidade e torna
a comunicação mais clara e fácil de entender.
...
<img
  className="block dark:hidden rounded-xl border border-gray-300"
  src="/images/new-agent/light/settings.png"
  alt="Configurações"
/>
<img
  className="hidden dark:block rounded-xl"
  src="/images/new-agent/dark/settings.png"
  alt="Configurações"
/>
...
<img
  className="block dark:hidden rounded-xl border border-gray-300"
  src="/images/new-agent/light/success.png"
  alt="Sucesso ao criar agente"
/>
<img
  className="hidden dark:block rounded-xl"
  src="/images/new-agent/dark/success.png"
  alt="Sucesso ao criar agente"
/>
